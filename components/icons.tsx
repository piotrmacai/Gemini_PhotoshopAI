...
export const PolygonIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M11.412 15.655 8.25 12.5l3.162-3.155m3.866 6.31L18.75 12.5l-3.162-3.155M12 21.75l-3.162-3.155m6.324 0L12 21.75m-3.866-6.31-3.162 3.155L2.25 12.5l3.162-3.155m6.324 0L12 2.25l3.162 3.155" />
    </svg>
);

export const SelectSubjectIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 6a3.75 3.75 0 1 1-7.5 0 3.75 3.75 0 0 1 7.5 0ZM4.501 20.118a7.5 7.5 0 0 1 14.998 0A17.933 17.933 0 0 1 12 21.75c-2.676 0-5.216-.584-7.499-1.632Z" />
    <path strokeLinecap="round" strokeLinejoin="round" strokeDasharray="2 2" d="M9 3.75H7.5a3 3 0 0 0-3 3v1.5M9 20.25H7.5a3 3 0 0 1-3-3v-1.5m6 4.5h1.5a3 3 0 0 0 3-3v-1.5m-6-13.5h1.5a3 3 0 0 1 3 3v1.5" />
  </svg>
);

export const SmartSelectIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M15.042 21.672 13.684 16.6m0 0-2.51 2.225.569-2.474a17.931 17.931 0 0 1-5.13-5.13l-2.474.569 2.225-2.51L3.328 12.345l1.096-2.261 2.262 1.096a17.931 17.931 0 0 1 5.13-5.13l1.096 2.262 2.261-1.096 2.261 1.096-1.096 2.262a17.931 17.931 0 0 1-5.13 5.13l-1.096-2.262-2.262 1.096L9.328 15.655Z" />
